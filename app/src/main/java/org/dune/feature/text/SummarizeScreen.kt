...
import org.dune.ForbiddenMachineViewModelFactory
import org.dune.R
...
internal fun SummarizeRoute(
    summarizeViewModel: SummarizeViewModel = viewModel(factory = ForbiddenMachineViewModelFactory)
) {
